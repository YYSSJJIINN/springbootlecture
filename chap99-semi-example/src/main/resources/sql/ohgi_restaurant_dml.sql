-- PASSWORD : 1234
INSERT INTO tbl_member (member_id, member_name, member_password, member_email) VALUES ('admin', '어두민', '$2a$10$COvazywgZPXseeKaYhruh.pAYYfcSeGO5aSrHOsLZN0X8joNwW2dW', 'ohgiraffers.owl@gmail.com');
INSERT INTO tbl_member (member_id, member_name, member_password, member_email) VALUES ('test01', '김회원', '$2a$10$N34MRj4tKVD0AxwvEcC8eOLUyBpXloPKE7Yw.S4/kj5fD1OU5BWsi', 'kim.test01@naver.com');
INSERT INTO tbl_member (member_id, member_name, member_password, member_email) VALUES ('test02', '이회원', '$2a$10$D4brGM7R0KAJDSQNaqBAJuymUw4W9Xd5OzEtjZ5AX0tDfD1hyymQ2', 'lee.test02@gmail.com');
